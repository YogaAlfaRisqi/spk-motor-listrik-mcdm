        ...
        <form wire:submit="register" class="space-y-5">
            ...
            <div>
                ...
                <input type="text"
                    ...
                    focus:ring-3 focus:ring-brand-500/10 focus:border-brand-300
            ...
            <div>
                ...
                <div x-data="{ showPassword: false }" class="relative">
                    <input :type="showPassword ? 'text' : 'password'"
                        ...
                        class="h-11 w-full rounded-lg border border-gray-300 px-4 pr-11 text-sm 
                        focus:ring-3 focus:ring-brand-500/10 focus:border-brand-300
                        dark:border-gray-700 dark:bg-gray-900 dark:text-white"
                        required>
            ...
            <!-- Button -->
            <button
                class="w-full rounded-lg bg-brand-500 py-3 text-sm font-medium text-white hover:bg-brand-600 transition">
                Sign Up
            </button>
        </form>
