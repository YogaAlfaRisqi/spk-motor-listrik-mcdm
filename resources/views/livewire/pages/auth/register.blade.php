                    ...
                    <div>
                        ...
                        <div x-data="{ showPassword: false }" class="relative">
                            ...
                            <input
                                ...
                                name="password"
                                placeholder="••••••••"
                                class="h-11 w-full rounded-lg border border-gray-300 bg-white px-4 py-2 pr-10 text-sm text-gray-800 shadow-sm transition duration-200 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/10 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                required
