                        ...
                        <table class="min-w-full border border-gray-200 dark:border-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                for($i = 1; $i <= $n; $i++) {
                                    ...
                                    $rank = $index + 1;
                                    $nMinusR = $n - $rank + 1;
                                    $bobotRS = $sumRS > 0 ? $nMinusR / $sumRS : 0;
                                    @endphp
                                    <tr>
                                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-white">{{ $item->nama_kriteria }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{{ $rank }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{{ $nMinusR }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{{ number_format($bobotRS, 4) }}</td>
                                    </tr>
                                    @endforeach
                                    <tr class="bg-gray-50 dark:bg-gray-800/50 font-semibold">
                                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-white" colspan="2">Total</td>
                                        <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{{ $sumRS }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">1.0000</td>
                                    </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="min-w-full border border-gray-200 dark:border-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                for($i = 1; $i <= count($bobot); $i++) {
                                    ...
                                    $rank = $index + 1;
                                    $reciprocal = 1 / $rank;
                                    $bobotRR = $sumRR > 0 ? $reciprocal / $sumRR : 0;
                                    @endphp
                                    <tr>
                                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-white">{{ $item->nama_kriteria }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{{ $rank }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{{ number_format($reciprocal, 4) }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{{ number_format($bobotRR, 4) }}</td>
                                    </tr>
                                    @endforeach
                                    <tr class="bg-gray-50 dark:bg-gray-800/50 font-semibold">
                                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-white" colspan="2">Total</td>
                                        <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{{ number_format($sumRR, 4) }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">1.0000</td>
                                    </tr>
                            </tbody>
                        </table>
